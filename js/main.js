function slideshow() {
    return window.setInterval(function () {
        loop++, loop %= 2, $("#home").attr("style", "background: url(img/carousel" + loop + ".jpg) no-repeat center center fixed; display: table; height: 690px; position: relative; top: 0%; width: 100%; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;")
    }, 6e3)
}

function pageTransition(t, e) {
    if (t != current) {
        if ($("#navigation").css("background-color", "rgba(16, 22, 54, 0.2)"), 0 == t ? ss = slideshow() : window.clearInterval(ss), isAnimating) return !1;
        isAnimating = !0, setAnimation(e > 0 && 68 > e ? e : Math.floor(67 * Math.random() + 1)), backupnext = t;
        var n = $pages.eq(current),
            i = $pages.eq(t).addClass("pt-page-current");
        n.addClass(outClass).on(animEndEventName, function () {
            n.off(animEndEventName), endCurrPage = !0, endNextPage && onEndAnimation(n, i)
        }), i.addClass(inClass).on(animEndEventName, function () {
            i.off(animEndEventName), endNextPage = !0, endCurrPage && onEndAnimation(n, i)
        }), support || onEndAnimation(n, i), current = backupnext
    }
}
...
function resetPage(t, e) {
    t.attr("class", t.data("originalClassList")), e.attr("class", e.data("originalClassList") + " pt-page-current")
}
...
function setnavbar() {
    $(window).width() < 768 ? ($(".navcolor").css("height", "70px"), $(".top-rht").css("top", "75px"), $(".top-lft").css("top", "75px")) : ($(".navcolor").css("height", "50px"), $(".top-rht").css("top", "55px"), $(".top-lft").css("top", "55px"))
}

function onReady(t) {
    function e() {
        void 0 !== document.getElementsByTagName("body")[0] && imagesloaded == totimg && (console.log("totimg" + totimg + " imagesloaded" + imagesloaded), document.getElementById("loading").innerHTML = "100%", window.clearInterval(n), t.call(this))
    }
...
if (! function (t, e) {
        ...
        function m(t, e) {
            var n, i, o, a, r, s, l, c;
            if (1 === e.nodeType) {
                if (ve.hasData(t) && (a = ve.access(t), r = ve.set(e, a), c = a.events)) {
                    delete r.handle, r.events = {};
                    for (o in c)
                        for (n = 0, i = c[o].length; i > n; n++) J.event.add(e, o, c[o][n])
                }
                ye.hasData(t) && (s = ye.access(t), l = J.extend({}, s), ye.set(e, l))
            }
        }
        ...
        function b(e, n) {
            var i, o = J(n.createElement(e)).appendTo(n.body),
                a = t.getDefaultComputedStyle && (i = t.getDefaultComputedStyle(o[0])) ? i.display : J.css(o[0], "display");
            return o.detach(), a
        }
        ...
        function x(t) {
            var e = Z,
                n = Re[t];
            return n || (n = b(t, e), "none" !== n && n || (He = (He || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = He[0].contentDocument, e.write(), e.close(), n = b(t, e), He.detach()), Re[t] = n), n
        }

        function w(t, e, n) {
            var i, o, a, r, s = t.style;
            return n = n || We(t), n && (r = n.getPropertyValue(e) || n[e]), n && ("" !== r || J.contains(t.ownerDocument, t) || (r = J.style(t, e)), qe.test(r) && Be.test(e) && (i = s.width, o = s.minWidth, a = s.maxWidth, s.minWidth = s.maxWidth = s.width = r, r = n.width, s.width = i, s.minWidth = o, s.maxWidth = a)), void 0 !== r ? r + "" : r
        }
        ...
        function T(t, e, n, i, o) {
            for (var a = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > a; a += 2) "margin" === n && (r += J.css(t, n + _e[a], !0, o)), i ? ("content" === n && (r -= J.css(t, "padding" + _e[a], !0, o)), "margin" !== n && (r -= J.css(t, "border" + _e[a] + "Width", !0, o))) : (r += J.css(t, "padding" + _e[a], !0, o), "padding" !== n && (r += J.css(t, "border" + _e[a] + "Width", !0, o)));
            return r
        }
        ...
        function $(t, e, n) {
            ...
            if (0 >= o || null == o) {
                if (o = w(t, e, a), (0 > o || null == o) && (o = t.style[e]), qe.test(o)) return o;
                i = r && (K.boxSizingReliable() || o === t.style[e]), o = parseFloat(o) || 0
            }
            return o + T(t, e, n || (r ? "border" : "content"), i, a) + "px"
        }

        function S(t, e) {
            for (var n, i, o, a = [], r = 0, s = t.length; s > r; r++) i = t[r], i.style && (a[r] = ve.get(i, "olddisplay"), n = i.style.display, e ? (a[r] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ce(i) && (a[r] = ve.access(i, "olddisplay", x(i.nodeName)))) : (o = Ce(i), "none" === n && o || ve.set(i, "olddisplay", o ? n : J.css(i, "display"))));
        ...
        function D(t, e) {
            ...
            for (e = e ? 1 : 0; 4 > i; i += 2 - e) n = _e[i], o["margin" + n] = o["padding" + n] = t;
            return e && (o.opacity = o.width = t), o
        }

        function j(t, e, n) {
            for (var i, o = (nn[e] || []).concat(nn["*"]), a = 0, r = o.length; r > a; a++)
                if (i = o[a].call(n, e, t)) return i
        }

        function M(t, e, n) {
            var i, o, a, r, s, l, c, u, p = this,
                d = {},
                f = t.style,
                h = t.nodeType && Ce(t),
                g = ve.get(t, "fxshow");
            ...
            if (J.isEmptyObject(d)) "inline" === ("none" === c ? x(t.nodeName) : c) && (f.display = c);
                ...
                g ? "hidden" in g && (h = g.hidden) : g = ve.access(t, "fxshow", {}), a && (g.hidden = !h), h ? J(t).show() : p.done(function () {
                    J(t).hide()
                }), p.done(function () {
                    var e;
                    ve.remove(t, "fxshow");
                ...
                for (i in d) r = j(h ? g[i] : 0, i, p), i in g || (g[i] = r.start, h && (r.end = r.start, r.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        function O(t, e) {
            var n, i, o, a, r;
            for (n in t)
                if (i = J.camelCase(n), o = e[i], a = t[n], J.isArray(a) && (o = a[1], a = t[n] = a[0]), n !== i && (t[i] = a, delete t[n]), r = J.cssHooks[i], r && "expand" in r) {
        ...
        function L(t, e, n) {
            var i, o, a = 0,
                ...
                l = function () {
                    if (o) return !1;
                    for (var e = Ke || A(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, a = 1 - i, r = 0, l = c.tweens.length; l > r; r++) c.tweens[r].run(a);
            ...
            return J.map(u, j, c), J.isFunction(c.opts.start) && c.opts.start.call(t, c), J.fx.timer(J.extend(l, {
                elem: t,
                anim: c,
                queue: c.opts.queue
        ...
        function N(t, e, n, i) {
            function o(s) {
                var l;
                return a[s] = !0, J.each(t[s] || [], function (t, s) {
                    var c = s(e, n, i);
        ...
        function R(t, e, n, i) {
            ...
            if (J.isArray(e)) J.each(e, function (e, o) {
                n || Tn.test(t) ? i(t, o) : R(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
            });
        ...
        J.fn = J.prototype = {
            ...
            var t, e, n, i, o, a, r = arguments[0] || {},
                ...
                l = arguments.length,
                c = !1;
            for ("boolean" == typeof r && (c = r, r = arguments[s] || {}, s++), "object" == typeof r || J.isFunction(r) || (r = {}), s === l && (r = this, s--); l > s; s++)
                if (null != (t = arguments[s]))
                    for (e in t) n = r[e], i = t[e], r !== i && (c && i && (J.isPlainObject(i) || (o = J.isArray(i))) ? (o ? (o = !1, a = n && J.isArray(n) ? n : []) : a = n && J.isPlainObject(n) ? n : {}, r[e] = J.extend(c, a, i)) : void 0 !== i && (r[e] = i));
            return r
        }, J.extend({
            ...
            makeArray: function (t, e) {
                var i = e || [];
                return null != t && (n(Object(t)) ? J.merge(i, "string" == typeof t ? [t] : t) : z.call(i, t)), i
            },
        ...
        var oe = function (t) {
            function e(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : R) !== M && j(e), e = e || M, n = n || [], s = e.nodeType, "string" != typeof t || !t || 1 !== s && 9 !== s && 11 !== s) return n;
                if (!i && L) {
                    if (11 !== s && (o = ye.exec(t)))
                        if (r = o[1]) {
                            if (9 === s) {
                            ...
                            } else if (e.ownerDocument && (a = e.ownerDocument.getElementById(r)) && I(e, a) && a.id === r) return n.push(a), n
                        } else {
                            if (o[2]) return G.apply(n, e.getElementsByTagName(t)), n;
                            if ((r = o[3]) && w.getElementsByClassName) return G.apply(n, e.getElementsByClassName(r)), n
                        } if (w.qsa && (!F || !F.test(t))) {
                        if (f = p = H, h = e, g = 1 !== s && t, 1 === s && "object" !== e.nodeName.toLowerCase()) {
                            for (c = T(t), (p = e.getAttribute("id")) ? f = p.replace(xe, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;) c[l] = f + d(c[l]);
            ...
            function f(t, e, n) {
                ...
                return e.first ? function (e, n, a) {
                    ...
                    if (r) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || o) {
                                if (l = e[H] || (e[H] = {}), (s = l[i]) && s[0] === B && s[1] === a) return c[2] = s[2];
            ...
            function v(t, e, n, o, a, r) {
                return o && !o[H] && (o = v(o)), a && !a[H] && (a = v(a, r)), i(function (i, r, s, l) {
                    var c, u, p, d = [],
                        ...
                        b = n ? a || (i ? t : h || o) ? [] : r : y;
                    if (n && n(y, b, s, l), o)
                        for (c = m(b, f), o(c, [], s, l), u = c.length; u--;)(p = c[u]) && (b[f[u]] = !(y[f[u]] = p));
                    if (i) {
                        if (a || t) {
                            if (a) {
                            ...
                            for (u = b.length; u--;)(p = b[u]) && (c = a ? te(i, p) : d[u]) > -1 && (i[c] = !(r[c] = p))
                        }
            ...
            function y(t) {
                for (var e, n, i, o = t.length, a = _.relative[t[0].type], r = a || _.relative[" "], s = a ? 1 : 0, l = f(function (t) {
                        ...
                        var o = !a && (i || n !== E) || ((e = n).nodeType ? l(t, n, i) : c(t, n, i));
                        return e = null, o
                    }]; o > s; s++)
                    if (n = _.relative[t[s].type]) u = [f(h(u), n)];
                        ...
                        if (n = _.filter[t[s].type].apply(null, t[s].matches), n[H]) {
                            ...
                            return v(s > 1 && h(u), s > 1 && d(t.slice(0, s - 1).concat({
                                value: " " === t[s - 2].type ? "*" : ""
                            })).replace(le, "$1"), n, i > s && y(t.slice(s, i)), o > i && y(t = t.slice(i)), o > i && d(t))
                        }
                        u.push(n)
                    } return h(u)
            }
            ...
            var x, w, _, C, k, T, $, S, E, A, D, j, M, O, L, F, N, P, I, H = "sizzle" + 1 * new Date,
                R = t.document,
                B = 0,
                q = 0,
                W = n(),
            ...
            w = e.support = {}, k = e.isXML = function (t) {
                ...
                return i !== M && 9 === i.nodeType && i.documentElement ? (M = i, O = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), L = !k(i), w.attributes = o(function (t) {
                ...
                }, N = [], F = [], (w.qsa = ve.test(i.querySelectorAll)) && (o(function (t) {
                ...
                })), (w.matchesSelector = ve.test(P = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function (t) {
                    w.disconnectedMatch = P.call(t, "div"), P.call(t, "[s!='']:x"), N.push("!=", re)
                }), F = F.length && new RegExp(F.join("|")), N = N.length && new RegExp(N.join("|")), e = ve.test(O.compareDocumentPosition), I = e || ve.test(O.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === R && I(R, t) ? -1 : e === i || e.ownerDocument === R && I(R, e) ? 1 : A ? te(A, t) - te(A, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e) return D = !0, 0;
                    var n, o = 0,
                        a = t.parentNode,
                        ...
                        l = [t],
                        c = [e];
                    if (!a || !s) return t === i ? -1 : e === i ? 1 : a ? -1 : s ? 1 : A ? te(A, t) - te(A, e) : 0;
                    if (a === s) return r(t, e);
                ...
                if ((t.ownerDocument || t) !== M && j(t), n = n.replace(pe, "='$1']"), !(!w.matchesSelector || !L || N && N.test(n) || F && F.test(n))) try {
                    var i = P.call(t, n);
                ...
                var e, n = [],
                    i = 0,
                    o = 0;
                if (D = !w.detectDuplicates, A = !w.sortStable && t.slice(0), t.sort(Q), D) {
                ...
                filter: {
                    ...
                    CHILD: function (t, e, n, i, o) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            var c, u, p, d, f, h, g = a !== r ? "nextSibling" : "previousSibling",
                                m = e.parentNode,
                            ...
                            if (m) {
                                ...
                                if (h = [r ? m.firstChild : m.lastChild], r && y) {
                                    for (u = m[H] || (m[H] = {}), c = u[t] || [], f = c[0] === B && c[1], d = c[0] === B && c[2], p = f && m.childNodes[f]; p = ++f && p && p[g] || (d = f = 0) || h.pop();)
                                    ...
                                    for (;
                                        (p = ++f && p && p[g] || (d = f = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (y && ((p[H] || (p[H] = {}))[t] = [B, d]), p !== e)););
                    ...
                    PSEUDO: function (t, n) {
                        ...
                        return a[H] ? a(n) : a.length > 1 ? (o = [t, t, "", n], _.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function (t, e) {
                            for (var i, o = a(t, n), r = o.length; r--;) i = te(t, o[r]), t[i] = !(e[i] = o[r])
                        }) : function (t) {
                            return a(t, 0, o)
                        }) : a
                    }
            ...
            return p.prototype = _.filters = _.pseudos, _.setFilters = new p, T = e.tokenize = function (t, n) {
                ...
                for (s = t, l = [], c = _.preFilter; s;) {
                    ...
                    for (r in _.filter) !(o = he[r].exec(s)) || c[r] && !(o = c[r](o)) || (i = o.shift(), a.push({
                        value: i,
                        type: r,
                        matches: o
                    }), s = s.slice(i.length));
                ...
                var n, i = [],
                    ...
                    a = z[t + " "];
                if (!a) {
                    for (e || (e = T(t)), n = e.length; n--;) a = y(e[n]), a[H] ? i.push(a) : o.push(a);
                ...
                if (n = n || [], 1 === p.length) {
                    if (a = p[0] = p[0].slice(0), a.length > 2 && "ID" === (r = a[0]).type && w.getById && 9 === e.nodeType && L && _.relative[a[1].type]) {
                        if (e = (_.find.ID(r.matches[0].replace(we, _e), e) || [])[0], !e) return n;
                        c && (e = e.parentNode), t = t.slice(a.shift().value.length)
                    }
                    for (o = he.needsContext.test(t) ? 0 : a.length; o-- && (r = a[o], !_.relative[s = r.type]);)
                        if ((l = _.find[s]) && (i = l(r.matches[0].replace(we, _e), be.test(a[0].type) && u(e.parentNode) || e))) {
                            if (a.splice(o, 1), t = i.length && d(a), !t) return G.apply(n, i), n;
                            break
                        }
                }
                return (c || $(t, p))(i, e, !L, n, be.test(t) && u(e.parentNode) || e), n
            }, w.sortStable = H.split("").sort(Q).join("") === H, w.detectDuplicates = !!D, j(), w.sortDetached = o(function (t) {
        ...
        J.filter = function (t, e, n) {
            ...
            is: function (t) {
                return !!i(this, "string" == typeof t && ae.test(t) ? J(t) : t || [], !1).length
            }
        });
        var le, ce = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
            ue = J.fn.init = function (t, e) {
                ...
                if ("string" == typeof t) {
                    ...
                    if (n[1]) {
                        if (e = e instanceof J ? e[0] : e, J.merge(this, J.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : Z, !0)), re.test(n[1]) && J.isPlainObject(e))
        ...
        J.extend({
            ...
            closest: function (t, e) {
                for (var n, i = 0, o = this.length, a = [], r = ae.test(t) || "string" != typeof t ? J(t, e || this.context) : 0; o > i; i++)
                    for (n = this[i]; n && n !== e; n = n.parentNode)
                        if (n.nodeType < 11 && (r ? r.index(n) > -1 : 1 === n.nodeType && J.find.matchesSelector(n, t))) {
                            a.push(n);
                            break
        ...
        J.Callbacks = function (t) {
            ...
            var e, n, i, o, r, s, l = [],
                c = !t.once && [],
                u = function (a) {
                    for (e = t.memory && a, n = !0, s = o || 0, o = 0, r = l.length, i = !0; l && r > s; s++)
                ...
                p = {
                        ...
                        if (l) {
                            ...
                            ! function a(e) {
                                J.each(e, function (e, n) {
                                    var i = J.type(n);
                                    "function" === i ? t.unique && p.has(n) || l.push(n) : n && n.length && "string" !== i && a(n)
                                })
                    ...
                    remove: function () {
                        return l && J.each(arguments, function (t, e) {
                            for (var n;
                                (n = J.inArray(e, l, n)) > -1;) l.splice(n, 1), i && (r >= n && r--, s >= n && s--)
                        }), this
                    },
                    has: function (t) {
            ...
            Deferred: function (t) {
                var e = [
                            ...
                            return J.Deferred(function (n) {
                                J.each(e, function (e, a) {
                                    ...
                                    o[a[1]](function () {
                                        ...
                                        t && J.isFunction(t.promise) ? t.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[a[0] + "With"](this === i ? n.promise() : this, r ? [t] : arguments)
                                    })
                                }), t = null
                            }).promise()
                        },
                    ...
                    o = {};
                return i.pipe = i.then, J.each(e, function (t, a) {
                    var r = a[2],
                        s = a[3];
            ...
            when: function (t) {
                var e, n, i, o = 0,
                    ...
                    c = function (t, n, i) {
                        return function (o) {
                            n[t] = this, i[t] = arguments.length > 1 ? W.call(arguments) : o, i === e ? l.notifyWith(n, i) : --s || l.resolveWith(n, i)
                        }
                    };
                if (r > 1)
                    for (e = new Array(r), n = new Array(r), i = new Array(r); r > o; o++) a[o] && J.isFunction(a[o].promise) ? a[o].promise().done(c(o, i, a)).fail(l.reject).progress(c(o, n, e)) : --s;
        ...
        J.fn.ready = function (t) {
            ...
            return ge || (ge = J.Deferred(), "complete" === Z.readyState ? setTimeout(J.ready) : (Z.addEventListener("DOMContentLoaded", r, !1), t.addEventListener("load", r, !1))), ge.promise(e)
        }, J.ready.promise();
        var me = J.access = function (t, e, n, i, o, a, r) {
            ...
            } else if (void 0 !== i && (o = !0, J.isFunction(i) || (r = !0), c && (r ? (e.call(t, i), e = null) : (c = e, e = function (t, e, n) {
                    return c.call(J(t), n)
                })), e))
        ...
        J.acceptData = function (t) {
            ...
            remove: function (t, e) {
                var n, i, o, a = this.key(t),
                    r = this.cache[a];
                if (void 0 === e) this.cache[a] = {};
                else {
                    J.isArray(e) ? i = e.concat(e.map(J.camelCase)) : (o = J.camelCase(e), e in r ? i = [e, o] : (i = o, i = i in r ? [i] : i.match(fe) || [])), n = i.length;
                    for (; n--;) delete r[i[n]]
                }
            },
            hasData: function (t) {
        ...
        J.extend({
            ...
            data: function (t, e) {
                ...
                if (void 0 === t) {
                    if (this.length && (o = ye.get(a), 1 === a.nodeType && !ve.get(a, "hasDataAttrs"))) {
                        for (n = r.length; n--;) r[n] && (i = r[n].name, 0 === i.indexOf("data-") && (i = J.camelCase(i.slice(5)), l(a, i, o[i])));
            ...
            promise: function (t, e) {
                ...
                for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;) n = ve.get(a[r], t + "queueHooks"), n && n.empty && (i++, n.empty.add(s));
        ...
        J.event = {
            ...
            add: function (t, e, n, i, o) {
                var a, r, s, l, c, u, p, d, f, h, g, m = ve.get(t);
                if (m)
                    for (n.handler && (a = n, n = a.handler, o = a.selector), n.guid || (n.guid = J.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function (e) {
                            return typeof J !== Te && J.event.triggered !== e.type ? J.event.dispatch.apply(t, arguments) : void 0
                        }), e = (e || "").match(fe) || [""], c = e.length; c--;) s = Ae.exec(e[c]) || [], f = g = s[1], h = (s[2] || "").split(".").sort(), f && (p = J.event.special[f] || {}, f = (o ? p.delegateType : p.bindType) || f, p = J.event.special[f] || {}, u = J.extend({
                        type: f,
                        origType: g,
                        data: i,
                        handler: n,
                        ...
                        namespace: h.join(".")
                    }, a), (d = l[f]) || (d = l[f] = [], d.delegateCount = 0, p.setup && p.setup.call(t, i, h, r) !== !1 || t.addEventListener && t.addEventListener(f, r, !1)), p.add && (p.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), J.event.global[f] = !0)
            },
            remove: function (t, e, n, i, o) {
                var a, r, s, l, c, u, p, d, f, h, g, m = ve.hasData(t) && ve.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(fe) || [""], c = e.length; c--;)
                        if (s = Ae.exec(e[c]) || [], f = g = s[1], h = (s[2] || "").split(".").sort(), f) {
                            for (p = J.event.special[f] || {}, f = (i ? p.delegateType : p.bindType) || f, d = l[f] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = a = d.length; a--;) u = d[a], !o && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(a, 1), u.selector && d.delegateCount--, p.remove && p.remove.call(t, u));
                            r && !d.length && (p.teardown && p.teardown.call(t, h, m.handle) !== !1 || J.removeEvent(t, f, m.handle), delete l[f])
                        } else
            ...
            trigger: function (e, n, i, o) {
                var a, r, s, l, c, u, p, d = [i || Z],
                    f = Y.call(e, "type") ? e.type : e,
                    h = Y.call(e, "namespace") ? e.namespace.split(".") : [];
                if (r = s = i = i || Z, 3 !== i.nodeType && 8 !== i.nodeType && !Ee.test(f + J.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[J.expando] ? e : new J.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : J.makeArray(n, [e]), p = J.event.special[f] || {}, o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
                    if (!o && !p.noBubble && !J.isWindow(i)) {
                        for (l = p.delegateType || f, Ee.test(l + f) || (r = r.parentNode); r; r = r.parentNode) d.push(r), s = r;
                        s === (i.ownerDocument || Z) && d.push(s.defaultView || s.parentWindow || t)
                    }
                    for (a = 0;
                        (r = d[a++]) && !e.isPropagationStopped();) e.type = a > 1 ? l : p.bindType || f, u = (ve.get(r, "events") || {})[e.type] && ve.get(r, "handle"), u && u.apply(r, n), u = c && r[c], u && u.apply && J.acceptData(r) && (e.result = u.apply(r, n), e.result === !1 && e.preventDefault());
                    return e.type = f, o || e.isDefaultPrevented() || p._default && p._default.apply(d.pop(), n) !== !1 || !J.acceptData(i) || c && J.isFunction(i[f]) && !J.isWindow(i) && (s = i[c], s && (i[c] = null), J.event.triggered = f, i[f](), J.event.triggered = void 0, s && (i[c] = s)), e.result
                }
            },
            dispatch: function (t) {
                t = J.event.fix(t);
                ...
                if (s[0] = t, t.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, t) !== !1) {
                    for (r = J.event.handlers.call(this, t, l), e = 0;
                        ...
                        for (t.currentTarget = o.elem, n = 0;
                            (a = o.handlers[n++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(a.namespace)) && (t.handleObj = a, t.data = a.data, i = ((J.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, s), void 0 !== i && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
                ...
                if (s && l.nodeType && (!t.button || "click" !== t.type))
                    for (; l !== this; l = l.parentNode || this)
                        if (l.disabled !== !0 || "click" !== t.type) {
                            for (i = [], n = 0; s > n; n++) a = e[n], o = a.selector + " ", void 0 === i[o] && (i[o] = a.needsContext ? J(o, this).index(l) >= 0 : J.find(o, this, null, [l]).length), i[o] && i.push(a);
                            i.length && r.push({
                                elem: l,
                                handlers: i
                            })
            ...
            mouseHooks: {
                ...
                filter: function (t, e) {
                    ...
                    return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || Z, i = n.documentElement, o = n.body, t.pageX = e.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), t.pageY = e.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)), t.which || void 0 === a || (t.which = 1 & a ? 1 : 2 & a ? 3 : 4 & a ? 2 : 0), t
                }
            },
            fix: function (t) {
                ...
                var e, n, i, o = t.type,
                    a = t,
                    r = this.fixHooks[o];
                for (r || (this.fixHooks[o] = r = Se.test(o) ? this.mouseHooks : $e.test(o) ? this.keyHooks : {}), i = r.props ? this.props.concat(r.props) : this.props, t = new J.Event(a), e = i.length; e--;) n = i[e], t[n] = a[n];
                return t.target || (t.target = Z), 3 === t.target.nodeType && (t.target = t.target.parentNode), r.filter ? r.filter(t, a) : t
            },
            special: {
                load: {
                    noBubble: !0
            ...
            J.event.special[t] = {
                ...
                handle: function (t) {
                    var n, i = this,
                        o = t.relatedTarget,
                        a = t.handleObj;
                    return (!o || o !== i && !J.contains(i, o)) && (t.type = a.origType, n = a.handler.apply(this, arguments), t.type = e), n
                }
            }
        ...
        Ie.optgroup = Ie.option, Ie.tbody = Ie.tfoot = Ie.colgroup = Ie.caption = Ie.thead, Ie.th = Ie.td, J.extend({
            clone: function (t, e, n) {
                ...
                if (!(K.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || J.isXMLDoc(t)))
                    for (r = v(s), a = v(t), i = 0, o = a.length; o > i; i++) y(a[i], r[i]);
                if (e)
                    if (n)
                        for (a = a || v(t), r = r || v(s), i = 0, o = a.length; o > i; i++) m(a[i], r[i]);
                    else m(t, s);
                return r = v(s, "script"), r.length > 0 && g(r, !l && v(t, "script")), s
            },
            buildFragment: function (t, e, n, i) {
                for (var o, a, r, s, l, c, u = e.createDocumentFragment(), p = [], d = 0, f = t.length; f > d; d++)
                    if (o = t[d], o || 0 === o)
                        if ("object" === J.type(o)) J.merge(p, o.nodeType ? [o] : o);
                        else if (Me.test(o)) {
                    for (a = a || u.appendChild(e.createElement("div")), r = (je.exec(o) || ["", ""])[1].toLowerCase(), s = Ie[r] || Ie._default, a.innerHTML = s[1] + o.replace(De, "<$1></$2>") + s[2], c = s[0]; c--;) a = a.lastChild;
                    J.merge(p, a.childNodes), a = u.firstChild, a.textContent = ""
                } else p.push(e.createTextNode(o));
                for (u.textContent = "", d = 0; o = p[d++];)
                    if ((!i || -1 === J.inArray(o, i)) && (l = J.contains(o.ownerDocument, o), a = v(u.appendChild(o), "script"), l && g(a), n))
                        for (c = 0; o = a[c++];) Fe.test(o.type || "") && n.push(o);
                return u
            },
            cleanData: function (t) {
                for (var e, n, i, o, a = J.event.special, r = 0; void 0 !== (n = t[r]); r++) {
                    if (J.acceptData(n) && (o = n[ve.expando], o && (e = ve.cache[o]))) {
                        if (e.events)
                            for (i in e.events) a[i] ? J.event.remove(n, i) : J.removeEvent(n, i, e.handle);
            ...
            html: function (t) {
                return me(this, function (t) {
                    ...
                    if ("string" == typeof t && !Oe.test(t) && !Ie[(je.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(De, "<$1></$2>");
                        try {
            ...
            domManip: function (t, e) {
                ...
                var n, i, o, a, r, s, l = 0,
                    ...
                    d = t[0],
                    g = J.isFunction(d);
                if (g || c > 1 && "string" == typeof d && !K.checkClone && Le.test(d)) return this.each(function (n) {
                    var i = u.eq(n);
                ...
                if (c && (n = J.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    for (o = J.map(v(n, "script"), f), a = o.length; c > l; l++) r = n, l !== p && (r = J.clone(r, !0, !0), a && J.merge(o, v(r, "script"))), e.call(this[l], r, l);
                    if (a)
                        for (s = o[o.length - 1].ownerDocument, J.map(o, h), l = 0; a > l; l++) r = o[l], Fe.test(r.type || "") && !ve.access(r, "globalEval") && J.contains(s, r) && (r.src ? J._evalUrl && J._evalUrl(r.src) : J.globalEval(r.textContent.replace(Pe, "")))
                }
                return this
            }
        }), J.each({
            ...
            J.fn[t] = function (t) {
                for (var n, i = [], o = J(t), a = o.length - 1, r = 0; a >= r; r++) n = r === a ? this : this.clone(!0), J(o[r])[e](n), z.apply(i, n.get());
        ...
        ! function () {
            function e() {
                r.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", r.innerHTML = "", o.appendChild(a);
            ...
            r.style && (r.style.backgroundClip = "content-box", r.cloneNode(!0).style.backgroundClip = "", K.clearCloneStyle = "content-box" === r.style.backgroundClip, a.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", a.appendChild(r), t.getComputedStyle && J.extend(K, {
                ...
                reliableMarginRight: function () {
                    var e, n = r.appendChild(Z.createElement("div"));
                    return n.style.cssText = r.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", n.style.marginRight = n.style.width = "0", r.style.width = "1px", o.appendChild(a), e = !parseFloat(t.getComputedStyle(n, null).marginRight), o.removeChild(a), r.removeChild(n), e
                }
            }))
        ...
        J.extend({
            ...
            style: function (t, e, n, i) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var o, a, r, s = J.camelCase(e),
                        l = t.style;
                    return e = J.cssProps[s] || (J.cssProps[s] = C(l, s)), r = J.cssHooks[e] || J.cssHooks[s], void 0 === n ? r && "get" in r && void 0 !== (o = r.get(t, !1, i)) ? o : l[e] : (a = typeof n, "string" === a && (o = Qe.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(J.css(t, e)), a = "number"), void(null != n && n === n && ("number" !== a || J.cssNumber[s] || (n += "px"), K.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), r && "set" in r && void 0 === (n = r.set(t, n, i)) || (l[e] = n))))
                }
            },
            css: function (t, e, n, i) {
                var o, a, r, s = J.camelCase(e);
                return e = J.cssProps[s] || (J.cssProps[s] = C(t.style, s)), r = J.cssHooks[e] || J.cssHooks[s], r && "get" in r && (o = r.get(t, !0, n)), void 0 === o && (o = w(t, e, i)), "normal" === o && e in Ve && (o = Ve[e]), "" === n || n ? (a = parseFloat(o), n === !0 || J.isNumeric(a) ? a || 0 : o) : o
            }
        }), J.each(["height", "width"], function (t, e) {
            J.cssHooks[e] = {
                get: function (t, n, i) {
                    return n ? Ue.test(J.css(t, "display")) && 0 === t.offsetWidth ? J.swap(t, Xe, function () {
                        return $(t, e, i)
                    }) : $(t, e, i) : void 0
                },
                set: function (t, n, i) {
                    var o = i && We(t);
                    return k(t, n, i ? T(t, e, i, "border-box" === J.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
            ...
            J.cssHooks[t + e] = {
                expand: function (n) {
                    for (var i = 0, o = {}, a = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) o[t + _e[i] + e] = a[i] || a[i - 2] || a[0];
                    return o
                }
            ...
            css: function (t, e) {
                return me(this, function (t, e, n) {
                    var i, o, a = {},
                        r = 0;
                    if (J.isArray(e)) {
                        for (i = We(t), o = e.length; o > r; r++) a[e[r]] = J.css(t, e[r], !1, i);
                        return a
                    }
            ...
            init: function (t, e, n, i, o, a) {
                this.elem = t, this.prop = n, this.easing = o || "swing", this.options = e, this.start = this.now = this.cur(), this.end = i, this.unit = a || (J.cssNumber[n] ? "" : "px")
            },
            cur: function () {
            ...
            run: function (t) {
                ...
                return this.pos = e = this.options.duration ? J.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : E.propHooks._default.set(this), this
            }
            ...
            nn = {
                "*": [function (t, e) {
                    var n = this.createTween(t, e),
                        ...
                        r = (J.cssNumber[t] || "px" !== a && +i) && Je.exec(J.css(n.elem, t)),
                        s = 1,
                        l = 20;
                    if (r && r[3] !== a) {
                        a = a || r[3], o = o || [], r = +i || 1;
                        do s = s || ".5", r /= s, J.style(n.elem, t, r + a); while (s !== (s = n.cur() / i) && 1 !== s && --l)
                    }
        ...
        J.Animation = J.extend(L, {
                ...
                stop: function (t, e, n) {
                    ...
                    return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function () {
                        ...
                        if (o) r[o] && r[o].stop && i(r[o]);
                            ...
                            for (o in r) r[o] && r[o].stop && tn.test(o) && i(r[o]);
                ...
                finish: function (t) {
                    return t !== !1 && (t = t || "fx"), this.each(function () {
                        var e, n = ve.get(this),
                            ...
                            a = J.timers,
                            r = i ? i.length : 0;
                        for (n.finish = !0, J.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = a.length; e--;) a[e].elem === this && a[e].queue === t && (a[e].anim.stop(!0), a.splice(e, 1));
                ...
                var t, e = 0,
                    n = J.timers;
                for (Ke = J.now(); e < n.length; e++) t = n[e], t() || n[e] !== t || n.splice(e--, 1);
            ...
            function () {
                ...
                t.type = "checkbox", K.checkOn = "" !== t.value, K.optSelected = n.selected, e.disabled = !0, K.optDisabled = !n.disabled, t = Z.createElement("input"), t.value = "t", t.type = "radio", K.radioValue = "t" === t.value
            }();
        var on, an, rn = J.expr.attrHandle;
        J.fn.extend({
            attr: function (t, e) {
            ...
            attr: function (t, e, n) {
                ...
                return t && 3 !== a && 8 !== a && 2 !== a ? typeof t.getAttribute === Te ? J.prop(t, e, n) : (1 === a && J.isXMLDoc(t) || (e = e.toLowerCase(), i = J.attrHooks[e] || (J.expr.match.bool.test(e) ? an : on)), void 0 === n ? i && "get" in i && null !== (o = i.get(t, e)) ? o : (o = J.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set" in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void J.removeAttr(t, e)) : void 0
            },
            removeAttr: function (t, e) {
                var n, i, o = 0,
                    a = e && e.match(fe);
                if (a && 1 === t.nodeType)
                    for (; n = a[o++];) i = J.propFix[n] || n, J.expr.match.bool.test(n) && (t[i] = !1), t.removeAttribute(n)
            },
            attrHooks: {
                type: {
                    set: function (t, e) {
            ...
            rn[e] = function (t, e, i) {
                var o, a;
                return i || (a = rn[e], rn[e] = o, o = null != n(t, e, i) ? e.toLowerCase() : null, rn[e] = a), o
            }
        });
        ...
        J.fn.extend({
            ...
            prop: function (t, e, n) {
                ...
                return t && 3 !== r && 8 !== r && 2 !== r ? (a = 1 !== r || !J.isXMLDoc(t), a && (e = J.propFix[e] || e, o = J.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e]) : void 0
            },
            propHooks: {
                tabIndex: {
                    get: function (t) {
        ...
        J.fn.extend({
            addClass: function (t) {
                var e, n, i, o, a, r, s = "string" == typeof t && t,
                    l = 0,
                    c = this.length;
            ...
            removeClass: function (t) {
                var e, n, i, o, a, r, s = 0 === arguments.length || "string" == typeof t && t,
                    l = 0,
                    c = this.length;
                if (J.isFunction(t)) return this.each(function (e) {
            ...
            toggleClass: function (t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(J.isFunction(t) ? function (n) {
                    ...
                    if ("string" === n)
                        for (var e, i = 0, o = J(this), a = t.match(fe) || []; e = a[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
        ...
        J.fn.extend({
            val: function (t) {
                ...
                })) : o ? (e = J.valHooks[o.type] || J.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(cn, "") : null == n ? "" : n)) : void 0
            }
        }), J.extend({
            valHooks: {
                option: {
                ...
                select: {
                    ...
                    set: function (t, e) {
                        for (var n, i, o = t.options, a = J.makeArray(e), r = o.length; r--;) i = o[r], (i.selected = J.inArray(i.value, a) >= 0) && (n = !0);
        ...
        J.extend({
            ...
            ajax: function (t, e) {
                function n(t, e, n, r) {
                    var l, u, v, y, x, _ = e;
                    2 !== b && (b = 2, s && clearTimeout(s), i = void 0, a = r || "", w.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = I(p, w, n)), y = H(p, y, w, l), l ? (p.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (J.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (J.etag[o] = x)), 204 === t || "HEAD" === p.type ? _ = "nocontent" : 304 === t ? _ = "notmodified" : (_ = y.state, u = y.data, v = y.error, l = !v)) : (v = _, (t || !_) && (_ = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || _) + "", l ? h.resolveWith(d, [u, _, w]) : h.rejectWith(d, [w, _, v]), w.statusCode(m), m = void 0, c && f.trigger(l ? "ajaxSuccess" : "ajaxError", [w, p, l ? u : v]), g.fireWith(d, [w, _]), c && (f.trigger("ajaxComplete", [w, p]), --J.active || J.event.trigger("ajaxStop")))
                }
                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, a, r, s, l, c, u, p = J.ajaxSetup({}, e),
                    d = p.context || p,
                ...
                if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, p.url = ((t || p.url || _n) + "").replace(dn, "").replace(vn, Cn[1] + "//"), p.type = e.method || e.type || p.method || p.type, p.dataTypes = J.trim(p.dataType || "*").toLowerCase().match(fe) || [""], null == p.crossDomain && (l = yn.exec(p.url.toLowerCase()), p.crossDomain = !(!l || l[1] === Cn[1] && l[2] === Cn[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (Cn[3] || ("http:" === Cn[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = J.param(p.data, p.traditional)), N(bn, p, e, w), 2 === b) return w;
                c = J.event && p.global, c && 0 === J.active++ && J.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !mn.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (pn.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = fn.test(o) ? o.replace(fn, "$1_=" + un++) : o + (pn.test(o) ? "&" : "?") + "_=" + un++)), p.ifModified && (J.lastModified[o] && w.setRequestHeader("If-Modified-Since", J.lastModified[o]), J.etag[o] && w.setRequestHeader("If-None-Match", J.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", p.contentType), w.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + wn + "; q=0.01" : "") : p.accepts["*"]);
                ...
                if (i = N(xn, p, e, w)) {
                    w.readyState = 1, c && f.trigger("ajaxSend", [w, p]), p.async && p.timeout > 0 && (s = setTimeout(function () {
                        w.abort("timeout")
                    }, p.timeout));
                    try {
                        b = 1, i.send(v, n)
        ...
        J.param = function (t, e) {
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    var t = this.type;
                    return this.name && !J(this).is(":disabled") && En.test(this.nodeName) && !Sn.test(t) && (this.checked || !ke.test(t))
                }).map(function (t, e) {
                    var n = J(this).val();
        ...
        t.attachEvent && t.attachEvent("onunload", function () {
        ...
        }), K.cors = !!Mn && "withCredentials" in Mn, K.ajax = Mn = !!Mn, J.ajaxTransport(function (t) {
            var e;
            return K.cors || Mn && !t.crossDomain ? {
                send: function (n, i) {
                    ...
                    e = function (t) {
                        return function () {
                            e && (delete Dn[r], e = a.onload = a.onerror = null, "abort" === t ? a.abort() : "error" === t ? i(a.status, a.statusText) : i(jn[a.status] || a.status, a.statusText, "string" == typeof a.responseText ? {
                                text: a.responseText
                            } : void 0, a.getAllResponseHeaders()))
                        }
                    }, a.onload = e(), a.onerror = e("error"), e = Dn[r] = e("abort");
                    try {
        ...
        J.ajaxSetup({
            ...
            var o, a, r, s = e.jsonp !== !1 && (Ln.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ln.test(e.data) && "data");
            return s || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = J.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Ln, "$1" + o) : e.jsonp !== !1 && (e.url += (pn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                return r || J.error(o + " was not called"), r[0]
            }, e.dataTypes[0] = "json", a = t[o], t[o] = function () {
                r = arguments
            }, i.always(function () {
                t[o] = a, e[o] && (e.jsonpCallback = n.jsonpCallback, On.push(o)), r && J.isFunction(a) && a(r[0]), r = a = void 0
            }), "script") : void 0
        ...
        J.fn.load = function (t, e, n) {
            ...
            var i, o, a, r = this,
                s = t.indexOf(" ");
            return s >= 0 && (i = J.trim(t.slice(s)), t = t.slice(0, s)), J.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), r.length > 0 && J.ajax({
                url: t,
                type: o,
                dataType: "html",
                data: e
            }).done(function (t) {
                a = arguments, r.html(i ? J("<div>").append(J.parseHTML(t)).find(i) : t)
        ...
        J.offset = {
            setOffset: function (t, e, n) {
                var i, o, a, r, s, l, c, u = J.css(t, "position"),
                    p = J(t),
                    d = {};
                "static" === u && (t.style.position = "relative"), s = p.offset(), a = J.css(t, "top"), l = J.css(t, "left"), c = ("absolute" === u || "fixed" === u) && (a + l).indexOf("auto") > -1, c ? (i = p.position(), r = i.top, o = i.left) : (r = parseFloat(a) || 0, o = parseFloat(l) || 0), J.isFunction(e) && (e = e.call(t, n, s)), null != e.top && (d.top = e.top - s.top + r), null != e.left && (d.left = e.left - s.left + o), "using" in e ? e.using.call(t, d) : p.css(d)
            }
        }, J.fn.extend({
            offset: function (t) {
                ...
                var e, n, i = this[0],
                    ...
                    a = i && i.ownerDocument;
                return a ? (e = a.documentElement, J.contains(e, i) ? (typeof i.getBoundingClientRect !== Te && (o = i.getBoundingClientRect()), n = B(a), {
            ...
            offsetParent: function () {
                return this.map(function () {
                    for (var t = this.offsetParent || Nn; t && !J.nodeName(t, "html") && "static" === J.css(t, "position");) t = t.offsetParent;
                    return t || Nn
                })
            }
        }), J.each({
            ...
            var i = "pageYOffset" === n;
            J.fn[e] = function (o) {
                return me(this, function (e, o, a) {
                    var r = B(e);
                    return void 0 === a ? r ? r[n] : e[o] : void(r ? r.scrollTo(i ? t.pageXOffset : a, i ? a : t.pageYOffset) : e[o] = a)
                }, e, o, arguments.length, null)
            }
        }), J.each(["top", "left"], function (t, e) {
            J.cssHooks[e] = _(K.pixelPosition, function (t, n) {
                return n ? (n = w(t, e), qe.test(n) ? J(t).position()[e] + "px" : n) : void 0
            })
        }), J.each({
            Height: "height",
            Width: "width"
            ...
            J.each({
                ...
                J.fn[i] = function (i, o) {
                    ...
                    return me(this, function (e, n, i) {
                        var o;
                        return J.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === i ? J.css(e, n, r) : J.style(e, n, i, r)
                    }, e, a ? i : void 0, a, null)
                }
            })
        }), J.fn.size = function () {
        ...
        return J.noConflict = function (e) {
            return t.$ === J && (t.$ = In), e && t.jQuery === J && (t.jQuery = Pn), J
        }, typeof e === Te && (t.jQuery = t.$ = J), J
    }), "undefined" == typeof jQuery) throw new Error("Bootstrap requires jQuery"); + function (t) {
    "use strict";
    ...
    t.fn.collapse = function (n) {
        ...
        var n, i = t(this),
            ...
            c = l && t(l);
        r && r.transitioning || (c && c.find('[data-toggle=collapse][data-parent="' + l + '"]').not(i).addClass("collapsed"), i[a.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), a.collapse(s)
    })
}(jQuery), + function (t) {
    "use strict";
    ...
    e.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (a) {
                ...
                i = "bottom" == i && r.top + r.height + l - p > f ? "top" : "top" == i && r.top - p - l < 0 ? "bottom" : "right" == i && r.right + s > d ? "left" : "left" == i && r.left - s < h ? "right" : i, n.removeClass(u).addClass(i)
            }
    ...
    t.MixItUp = function () {
        ...
        _addHook: function (e, n, i, o, a) {
            var r = t.MixItUp.prototype[e],
                s = {};
            a = 1 === a || "post" === a ? "post" : "pre", s[n] = {}, s[n][a] = {}, s[n][a][i] = o, t.extend(!0, r, s)
        },
        _init: function (e, n) {
            var i = this;
        ...
        _platformDetect: function () {
            var t = this,
                ...
                s = r(t._domNode);
            t._execAction("_platformDetect", 0), t._chrome = o ? parseInt(o[1], 10) : !1, t._ff = a ? parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1]) : !1, t._prefix = s.prefix, t._vendor = s.vendor, t._suckMode = window.atob && t._prefix ? !1 : !0, t._suckMode && (t.animation.enable = !1), t._ff && t._ff <= 4 && (t.animation.enable = !1);
        ...
        _bindHandlers: function () {
            ...
            n._execAction("_bindHandlers", 0), n.controls.live ? n._$body.on("click.mixItUp." + n._id, n.selectors.sort, function () {
                ...
                n._processClick(t(this), "filter")
            })), i[n.selectors.filter] = i[n.selectors.filter] === e ? 1 : i[n.selectors.filter] + 1, o[n.selectors.sort] = o[n.selectors.sort] === e ? 1 : o[n.selectors.sort] + 1, n._execAction("_bindHandlers", 1)
        },
        _processClick: function (n, i) {
            var o = this,
                a = function (n, i, a) {
                    var r = t.MixItUp.prototype;
                    r._handled["_" + i][o.selectors[i]] = r._handled["_" + i][o.selectors[i]] === e ? 1 : r._handled["_" + i][o.selectors[i]] + 1, r._handled["_" + i][o.selectors[i]] === r._bound["_" + i][o.selectors[i]] && (n[(a ? "remove" : "add") + "Class"](o.controls.activeClass), delete r._handled["_" + i][o.selectors[i]])
                };
            if (o._execAction("_processClick", 0, arguments), !o._mixing || o.animation.queue && o._queue.length < o.animation.queueLimit) {
                if (o._clicking = !0, "sort" === i) {
                    ...
                    (!n.hasClass(o.controls.activeClass) || r.indexOf("random") > -1) && (t(o.selectors.sort).removeClass(o.controls.activeClass), a(n, i), o.sort(r))
                }
                if ("filter" === i) {
                    var s, l = n.attr("data-filter"),
                        c = "or" === o.controls.toggleLogic ? "," : "";
                    o.controls.toggleFilterButtons ? (o._buildToggleArray(), n.hasClass(o.controls.activeClass) ? (a(n, i, !0), s = o._toggleArray.indexOf(l), o._toggleArray.splice(s, 1)) : (a(n, i), o._toggleArray.push(l)), o._toggleArray = t.grep(o._toggleArray, function (t) {
                        return t
                    }), o._toggleString = o._toggleArray.join(c), o.filter(o._toggleString)) : n.hasClass(o.controls.activeClass) || (t(o.selectors.filter).removeClass(o.controls.activeClass), a(n, i), o.filter(l))
                }
        ...
        _updateControls: function (n, i) {
            var o = this,
                ...
                r = function (t, e) {
                    i && "filter" == s && "none" !== a.filter && "" !== a.filter ? t.filter(e).addClass(o.controls.activeClass) : t.removeClass(o.controls.activeClass).filter(e).addClass(o.controls.activeClass)
                },
                s = "filter",
                l = null;
            o._execAction("_updateControls", 0, arguments), n.filter === e && (a.filter = o._activeFilter), n.sort === e && (a.sort = o._activeSort), a.filter === o.selectors.target && (a.filter = "all");
            for (var c = 0; 2 > c; c++) l = o.controls.live ? t(o.selectors[s]) : o["_$" + s + "Buttons"], l && r(l, "[data-" + s + '="' + a[s] + '"]'), s = "sort";
        ...
        _compare: function (t, e, n) {
            ...
            return s > r ? "asc" == o ? -1 : 1 : r > s ? "asc" == o ? 1 : -1 : r == s && i._newSort.length > n + 1 ? i._compare(t, e, n + 1) : 0
        },
        _printSort: function (t) {
            ...
            for (var r = 0; r < n.length; r++) {
                var c = n[r];
                if ("default" != e._newSort[0].sortBy || "desc" != e._newSort[0].order || t) a.appendChild(c), a.appendChild(document.createTextNode(" "));
                else {
                    var u = a.firstChild;
                    a.insertBefore(c, u), a.insertBefore(document.createTextNode(" "), c)
                }
            }
            o ? e._$parent[0].insertBefore(a, o) : e._$parent[0].appendChild(a), e._execAction("_printSort", 1, arguments)
        },
        _parseSort: function (t) {
            for (var e = this, n = "string" == typeof t ? t.split(" ") : [t], i = [], o = 0; o < n.length; o++) {
                var a = "string" == typeof t ? n[o].split(":") : ["custom", n[o]],
                    r = {
                        sortBy: e._helpers._camelCase(a[0]),
                        order: a[1] || "asc"
                    };
        ...
        _parseEffects: function () {
            ...
            return e.opacity = n("fade") ? n("fade", !0).val || "0" : "1", o("transformIn"), t.animation.reverseOut ? o("transformOut", !0) : e.transformOut = e.transformIn, e.transition = {}, e.transition = t._getPrefixedCSS("transition", "all " + t.animation.duration + "ms " + t.animation.easing + ", opacity " + t.animation.duration + "ms linear"), t.animation.stagger = n("stagger") ? !0 : !1, t.animation.staggerDuration = parseInt(n("stagger") && n("stagger", !0).val ? n("stagger", !0).val : 100), t._execFilter("_parseEffects", e)
        },
        ...
        _goMix: function (t) {
            var e = this,
                n = function () {
                    e._chrome && 31 === e._chrome && a(e._$parent[0]), e._setInter(), i()
                },
                i = function () {
                    var t = window.pageYOffset,
                        n = window.pageXOffset;
                    document.documentElement.scrollHeight, e._getInterMixData(), e._setFinal(), e._getFinalMixData(), window.pageYOffset !== t && window.scrollTo(n, t), e._prepTargets(), window.requestAnimationFrame ? requestAnimationFrame(o) : setTimeout(function () {
                        o()
                    }, 20)
                },
                o = function () {
        ...
        _getTargetData: function (t, e) {
            var n, i = this;
            t.dataset[e + "PosX"] = t.offsetLeft, t.dataset[e + "PosY"] = t.offsetTop, i.animation.animateResizeTargets && (n = window.getComputedStyle(t), t.dataset[e + "MarginBottom"] = parseInt(n.marginBottom), t.dataset[e + "MarginRight"] = parseInt(n.marginRight), t.dataset[e + "Width"] = t.offsetWidth, t.dataset[e + "Height"] = t.offsetHeight)
        },
        ...
        _prepTargets: function () {
            ...
            for (var i = 0; i < e._$toShow.length; i++) {
                var o = e._$toShow[i],
                    a = t(o);
                o.style.opacity = e.effects.opacity, o.style.display = e._changingLayout && e.animation.animateChangeLayout ? e._newDisplay : e.layout.display, a.css(n._in), e.animation.animateResizeTargets && (o.style.width = o.dataset.finalWidth + "px", o.style.height = o.dataset.finalHeight + "px", o.style.marginRight = -(o.dataset.finalWidth - o.dataset.interWidth) + 1 * o.dataset.finalMarginRight + "px", o.style.marginBottom = -(o.dataset.finalHeight - o.dataset.interHeight) + 1 * o.dataset.finalMarginBottom + "px")
            }
            for (var i = 0; i < e._$pre.length; i++) {
                var o = e._$pre[i],
                    ...
                    n = e._getPrefixedCSS("transform", "translate(" + r.x + "px," + r.y + "px)");
                a.css(n), e.animation.animateResizeTargets && (o.style.width = o.dataset.origWidth + "px", o.style.height = o.dataset.origHeight + "px", o.dataset.origWidth - o.dataset.finalWidth && (o.style.marginRight = -(o.dataset.origWidth - o.dataset.interWidth) + 1 * o.dataset.origMarginRight + "px"), o.dataset.origHeight - o.dataset.finalHeight && (o.style.marginBottom = -(o.dataset.origHeight - o.dataset.interHeight) + 1 * o.dataset.origMarginBottom + "px"))
            }
        ...
        _animateTargets: function () {
            ...
            for (var n = 0; n < e._$toShow.length; n++) {
                ...
                for (var l = 0; 2 > l; l++) {
                    ...
                    e._ff && e._ff <= 20 && (s[c + "transition-property"] = "all", s[c + "transition-timing-function"] = e.animation.easing + "ms", s[c + "transition-duration"] = e.animation.duration + "ms"), s[c + "transition-delay"] = r + "ms", s[c + "transform"] = "translate(" + a.x + "px," + a.y + "px)"
            ...
            for (var n = 0; n < e._$pre.length; n++) {
                var i = e._$pre[n],
                    ...
                    r = e._getDelay(n);
                (i.dataset.finalPosX !== i.dataset.origPosX || i.dataset.finalPosY !== i.dataset.origPosY) && e._bindTargetDone(o), o.css(e._getPrefixedCSS("transition", "all " + e.animation.duration + "ms " + e.animation.easing + " " + r + "ms")), o.css(e._getPrefixedCSS("transform", "translate(" + a.x + "px," + a.y + "px)")), e.animation.animateResizeTargets && (i.dataset.origWidth - i.dataset.finalWidth && 1 * i.dataset.finalWidth && (i.style.width = i.dataset.finalWidth + "px", i.style.marginRight = -(i.dataset.finalWidth - i.dataset.interWidth) + 1 * i.dataset.finalMarginRight + "px"), i.dataset.origHeight - i.dataset.finalHeight && 1 * i.dataset.finalHeight && (i.style.height = i.dataset.finalHeight + "px", i.style.marginBottom = -(i.dataset.finalHeight - i.dataset.interHeight) + 1 * i.dataset.finalMarginBottom + "px"))
            }
            e._changingClass && e._$container.removeClass(e.layout.containerClass).addClass(e._newClass);
            for (var n = 0; n < e._$toHide.length; n++) {
                for (var i = e._$toHide[n], o = t(i), r = e._getDelay(n), u = {}, l = 0; 2 > l; l++) {
                    var c = 0 === l ? c = e._prefix : "";
                    u[c + "transition-delay"] = r + "ms", u[c + "transform"] = e.effects.transformOut, u.opacity = e.effects.opacity
                }
        ...
        _bindTargetDone: function (e) {
            var n = this,
                i = e[0];
            n._execAction("_bindTargetDone", 0, arguments), i.dataset.bound || (i.dataset.bound = !0, n._targetsBound++, e.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function (o) {
                (o.originalEvent.propertyName.indexOf("transform") > -1 || o.originalEvent.propertyName.indexOf("opacity") > -1) && t(o.originalEvent.target).is(n.selectors.target) && (e.off(".mixItUp"), delete i.dataset.bound, n._targetDone())
        ...
        _parseInsertArgs: function (e) {
            for (var n = this, i = {
                ...
                var a = e[o];
                "number" == typeof a ? i.index = a : "object" == typeof a && a instanceof t ? i.$object = a : "object" == typeof a && n._helpers._isElement(a) ? i.$object = t(a) : "object" == typeof a && null !== a ? i.multiMix = a : "boolean" != typeof a || a ? "function" == typeof a && (i.callback = a) : i.multiMix = !1
            }
        ...
        multiMix: function () {
            ...
            if (t._execAction("multiMix", 0, arguments), t._mixing) t.animation.queue && t._queue.length < t.animation.queueLimit ? (t._queue.push(arguments), t.controls.enable && !t._clicking && t._updateControls(n.command), t._execAction("multiMixQueue", 1, arguments)) : ("function" == typeof t.callbacks.onMixBusy && t.callbacks.onMixBusy.call(t._domNode, t._state, t), t._$container.trigger("mixBusy", [t._state, t]), t._execAction("multiMixBusy", 1, arguments));
                ...
                t._refresh(), i && (t._newSort = t._parseSort(i), t._newSortString = i, t._sorting = !0, t._sort()), o !== e && (o = "all" === o ? t.selectors.target : o, t._activeFilter = o), t._filter(), a && (t._newDisplay = "string" == typeof a ? a : a.display || t.layout.display, t._newClass = a.containerClass || "", (t._newDisplay !== t.layout.display || t._newClass !== t.layout.containerClass) && (t._changingLayout = !0, t._changingClass = t._newClass !== t.layout.containerClass, t._changingDisplay = t._newDisplay !== t.layout.display)), t._$targets.css(t._brake), t._goMix(n.animate ^ t.animation.enable ? n.animate : t.animation.enable), t._execAction("multiMix", 1, arguments)
            }
        },
        insert: function () {
            var t = this,
        ...
        getOption: function (t) {
            var n = this,
                i = function (t, n) {
                    for (var i = n.split("."), o = i.pop(), a = i.length, r = 1, s = i[0] || n;
                        (t = t[s]) && a > r;) s = i[r], r++;
        ...
        destroy: function (e) {
            ...
            n._execAction("destroy", 1, arguments), delete t.MixItUp.prototype._instances[n._id]
        }
        ...
        var n, i = arguments,
            ...
            a = function (e, n) {
                ...
                i._execAction("_instantiate", 0, arguments), e.id = e.id ? e.id : "MixItUp" + o(), i._instances[e.id] || (i._instances[e.id] = i, i._init(e, n)), i._execAction("_instantiate", 1, arguments)
            };
        ...
        return n = n ? n : "", this.each(function () {
            for (var i = this, o = t.split(" "), a = 0; a < o.length; a++)
                for (var r = 0; 2 > r; r++) {
                    var s = r ? o[a] : n + o[a];
                    if (i.style[s] !== e && "unknown" != typeof i.style[s] && i.style[s].length > 0 && (i.style[s] = ""), !n) break
                }
            i.attributes && i.attributes.style && i.attributes.style !== e && "" === i.attributes.style.nodeValue && i.attributes.removeNamedItem("style")
        })
    }
}(jQuery),
function (t, e, n, i) {
    ...
    n.extend(s, {
        ...
        helpers: {},
        open: function (t, e) {
            return t && (n.isPlainObject(e) || (e = {}), !1 !== s.close(!0)) ? (n.isArray(t) || (t = p(t) ? n(t).get() : [t]), n.each(t, function (o, a) {
                var r, l, c, u, f, h = {};
                "object" === n.type(a) && (a.nodeType && (a = n(a)), p(a) ? (h = {
                    href: a.data("fancybox-href") || a.attr("href"),
                    title: a.data("fancybox-title") || a.attr("title"),
                    isDom: !0,
                    element: a
                }, n.metadata && n.extend(!0, h, a.metadata())) : h = a), r = e.href || h.href || (d(a) ? a : null), l = e.title !== i ? e.title : h.title || "", u = (c = e.content || h.content) ? "html" : e.type || h.type, !u && h.isDom && (u = a.data("fancybox-type"), u || (u = (u = a.prop("class").match(/fancybox\.(\w+)/)) ? u[1] : null)), d(r) && (u || (s.isImage(r) ? u = "image" : s.isSWF(r) ? u = "swf" : "#" === r.charAt(0) ? u = "inline" : d(a) && (u = "html", c = a)), "ajax" === u && (f = r.split(/\s+/, 2), r = f.shift(), f = f.shift())), c || ("inline" === u ? r ? c = n(d(r) ? r.replace(/.*(?=#[^\s]+$)/, "") : r) : h.isDom && (c = a) : "html" === u ? c = r : !u && !r && h.isDom && (u = "inline", c = a)), n.extend(h, {
                    href: r,
                    type: u,
                    content: c,
                    title: l,
            ...
            }), s.opts = n.extend(!0, {}, s.defaults, e), e.keys !== i && (s.opts.keys = e.keys ? n.extend({}, s.defaults.keys, e.keys) : !1), s.group = t, s._start(s.opts.index)) : void 0
        },
        cancel: function () {
            var t = s.coming;
        ...
        jumpto: function (t, e, n) {
            var o = s.current;
            o && (t = h(t), s.direction = e || o.direction[t >= o.index ? "next" : "prev"], s.router = n || "jumpto", o.loop && (0 > t && (t = o.group.length + t % o.group.length), t %= o.group.length), o.group[t] !== i && (s.cancel(), s._start(t)))
        },
        reposition: function (t, e) {
            var i, o = s.current,
                a = o ? o.wrap : null;
            a && (i = s._getPosition(e), t && "scroll" === t.type ? (delete i.position, a.stop(!0, !0).animate(i, 200)) : (a.css(i), o.pos = n.extend({}, o.dim, i)))
        },
        update: function (t) {
            var e = t && t.type,
        ...
        showLoading: function () {
            var t, e;
            s.hideLoading(), t = n('<div id="fancybox-loading"><div></div></div>').click(s.cancel).appendTo("body"), r.bind("keydown.loading", function (t) {
        ...
        getViewport: function () {
            ...
            return e ? (n.w = e[0].clientWidth, n.h = e[0].clientHeight) : (n.w = u && t.innerWidth ? t.innerWidth : a.width(), n.h = u && t.innerHeight ? t.innerHeight : a.height()), n
        },
        ...
        bindEvents: function () {
            var t, e = s.current;
            e && (a.bind("orientationchange.fb" + (u ? "" : " resize.fb") + (e.autoCenter && !e.locked ? " scroll.fb" : ""), s.update), (t = e.keys) && r.bind("keydown.fb", function (o) {
                var a = o.which || o.keyCode,
                    r = o.target || o.srcElement;
                return 27 === a && s.coming ? !1 : void!(o.ctrlKey || o.altKey || o.shiftKey || o.metaKey || r && (r.type || n(r).is("[contenteditable]")) || !n.each(t, function (t, r) {
                    return 1 < e.group.length && r[a] !== i ? (s[t](r[a]), o.preventDefault(), !1) : -1 < n.inArray(a, r) ? (s[t](), o.preventDefault(), !1) : void 0
                }))
            }), n.fn.mousewheel && e.mouseWheel && s.wrap.bind("mousewheel.fb", function (t, i, o, a) {
                for (var r = n(t.target || null), l = !1; r.length && !l && !r.is(".fancybox-skin") && !r.is(".fancybox-wrap");) l = r[0] && !(r[0].style.overflow && "hidden" === r[0].style.overflow) && (r[0].clientWidth && r[0].scrollWidth > r[0].clientWidth || r[0].clientHeight && r[0].scrollHeight > r[0].clientHeight), r = n(r).parent();
                0 !== i && !l && 1 < s.group.length && !e.canShrink && (a > 0 || o > 0 ? s.prev(a > 0 ? "down" : "left") : (0 > a || 0 > o) && s.next(0 > a ? "up" : "right"), t.preventDefault())
            }))
        },
        trigger: function (t, e) {
        ...
        _start: function (t) {
            ...
            if (o = n.extend(!0, {}, s.opts, e), e = o.margin, i = o.padding, "number" === n.type(e) && (o.margin = [e, e, e, e]), "number" === n.type(i) && (o.padding = [i, i, i, i]), o.modal && n.extend(!0, o, {
                ...
                if (i = o.type, e = o.href, !i) return s.coming = null, s.current && s.router && "jumpto" !== s.router ? (s.current.index = t, s[s.router](s.direction)) : !1;
        ...
        _afterLoad: function () {
            var t, e, i, o, a, r = s.coming,
                l = s.current;
            if (s.hideLoading(), r && !1 !== s.isActive)
                if (!1 === s.trigger("afterLoad", r, l)) r.wrap.stop(!0).trigger("onReset").remove(), s.coming = null;
                else {
                    switch (l && (s.trigger("beforeChange", l), l.wrap.stop(!0).removeClass("fancybox-opened").find(".fancybox-item, .fancybox-nav").remove()), s.unbindEvents(), t = r.content, e = r.type, i = r.scrolling, n.extend(s, {
                        wrap: r.wrap,
                        skin: r.skin,
                        outer: r.outer,
                        inner: r.inner,
                        ...
                        case "ajax":
                        case "html":
                            r.selector ? t = n("<div>").html(t).find(r.selector) : p(t) && (t.data("fancybox-placeholder") || t.data("fancybox-placeholder", n('<div class="fancybox-placeholder"></div>').insertAfter(t).hide()), t = t.show().detach(), r.wrap.bind("onReset", function () {
                        ...
                        case "image":
                            ...
                            break;
                        case "swf":
                            t = '<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' + o + '"></param>', a = "", n.each(r.swf, function (e, n) {
        ...
        _setDimension: function () {
            var t, e, i, o, a, r, l, c, u, p = s.getViewport(),
                d = 0,
                m = !1,
                v = !1,
                m = s.wrap,
                ...
                A = h(E[1] + E[3]),
                D = h(E[0] + E[2]);
            if (m.add(y).add(b).width("auto").height("auto").removeClass("fancybox-tmp"), E = h(y.outerWidth(!0) - y.width()), t = h(y.outerHeight(!0) - y.height()), e = A + E, i = D + t, o = f(v) ? (p.w - e) * h(v) / 100 : v, a = f(w) ? (p.h - i) * h(w) / 100 : w, "iframe" === x.type) {
                if (u = x.content, x.autoHeight && 1 === u.data("ready")) try {
                    u[0].contentWindow.document.location && (b.width(o).height(9999), r = u.contents().find("body"), S && r.css("overflow-x", "hidden"), a = r.outerHeight(!0))
                } catch (j) {}
            ...
            if (v = h(o), w = h(a), c = o / a, _ = h(f(_) ? h(_, "w") - e : _), k = h(f(k) ? h(k, "w") - e : k), C = h(f(C) ? h(C, "h") - i : C), T = h(f(T) ? h(T, "h") - i : T), r = k, l = T, x.fitToView && (k = Math.min(p.w - e, k), T = Math.min(p.h - i, T)), e = p.w - A, D = p.h - D, x.aspectRatio ? (v > k && (v = k, w = h(v / c)), w > T && (w = T, v = h(w * c)), _ > v && (v = _, w = h(v / c)), C > w && (w = C, v = h(w * c))) : (v = Math.max(_, Math.min(v, k)), x.autoHeight && "iframe" !== x.type && (b.width(v), w = b.height()), w = Math.max(C, Math.min(w, T))), x.fitToView)
                if (b.width(v).height(w), m.width(v + E), p = m.width(), A = m.height(), x.aspectRatio)
                    for (;
                        (p > e || A > D) && v > _ && w > C && !(19 < d++);) w = Math.max(C, Math.min(T, w - 10)), v = h(w * c), _ > v && (v = _, w = h(v / c)), v > k && (v = k, w = h(v / c)), b.width(v).height(w), m.width(v + E), p = m.width(), A = m.height();
                else v = Math.max(_, Math.min(v, v - (p - e))), w = Math.max(C, Math.min(w, w - (A - D)));
            S && "auto" === $ && a > w && e > v + E + S && (v += S), b.width(v).height(w), m.width(v + E), p = m.width(), A = m.height(), m = (p > e || A > D) && v > _ && w > C, v = x.aspectRatio ? r > v && l > w && o > v && a > w : (r > v || l > w) && (o > v || a > w), n.extend(x, {
                dim: {
                    width: g(p),
                    height: g(A)
                },
        ...
        _getPosition: function (t) {
            ...
            return e.autoCenter && e.fixed && !t && a <= n.h && o <= n.w ? i.position = "fixed" : e.locked || (i.top += n.y, i.left += n.x), i.top = g(Math.max(i.top, i.top + (n.h - a) * e.topRatio)), i.left = g(Math.max(i.left, i.left + (n.w - o) * e.leftRatio)), i
        },
        _afterZoomIn: function () {
            ...
            }), t.arrows && 1 < s.group.length && ((t.loop || 0 < t.index) && n(t.tpl.prev).appendTo(s.outer).bind("click.fb", s.prev), (t.loop || t.index < s.group.length - 1) && n(t.tpl.next).appendTo(s.outer).bind("click.fb", s.next)), s.trigger("afterShow"), t.loop || t.index !== t.group.length - 1 ? s.opts.autoPlay && !s.player.isActive && (s.opts.autoPlay = !1, s.play()) : s.play(!1))
        },
        ...
        getOrigPosition: function () {
            var t = s.current,
                ...
                l = t.wPadding,
                c = s.getViewport();
            return !n && t.isDom && e.is(":visible") && (n = e.find("img:first"), n.length || (n = e)), p(n) ? (i = n.offset(), n.is("img") && (o = n.outerWidth(), a = n.outerHeight())) : (i.top = c.y + (c.h - a) * t.topRatio, i.left = c.x + (c.w - o) * t.leftRatio), ("fixed" === s.wrap.css("position") || t.locked) && (i.top -= c.y, i.left -= c.x), i = {
        ...
        step: function (t, e) {
            ...
            var a = i.wrapSpace,
                r = i.skinSpace;
            ("width" === o || "height" === o) && (n = e.end === e.start ? 1 : (t - e.start) / (e.end - e.start), s.isClosing && (n = 1 - n), i = "width" === o ? i.wPadding : i.hPadding, i = t - i, s.skin[o](h("width" === o ? i : i - a * n)), s.inner[o](h("width" === o ? i : i - a * n - r * n)))
        },
        zoomIn: function () {
            var t = s.current,
                e = t.pos,
            ...
            delete a.position, o ? (e = this.getOrigPosition(), t.openOpacity && (e.opacity = .1)) : "fade" === i && (e.opacity = .1), s.wrap.css(e).animate(a, {
        ...
        changeIn: function () {
            var t, e = s.current,
                ...
                a = s.direction;
            i.opacity = .1, "elastic" === n && (t = "down" === a || "up" === a ? "top" : "left", "down" === a || "right" === a ? (i[t] = g(h(i[t]) - 200), o[t] = "+=200px") : (i[t] = g(h(i[t]) + 200), o[t] = "-=200px")), "none" === n ? s._afterZoomIn() : s.wrap.css(i).animate(o, {
        ...
        el: n("html"),
        create: function (t) {
            t = n.extend({}, this.defaults, t), this.overlay && this.close(), this.overlay = n('<div class="fancybox-overlay"></div>').appendTo(s.coming ? s.coming.parent : t.parent), this.fixed = !1, t.fixed && s.defaults.fixed && (this.overlay.addClass("fancybox-overlay-fixed"), this.fixed = !0)
        },
        open: function (t) {
            var e = this;
            t = n.extend({}, this.defaults, t), this.overlay ? this.overlay.unbind(".overlay").width("auto").height("auto") : this.create(t), this.fixed || (a.bind("resize.overlay", n.proxy(this.update, this)), this.update()), t.closeClick && this.overlay.bind("click.overlay", function (t) {
                return n(t.target).hasClass("fancybox-overlay") ? (s.isActive ? s.close() : e.close(), !1) : void 0
        ...
        update: function () {
            var t, n = "100%";
            this.overlay.width(n).height("100%"), l ? (t = Math.max(e.documentElement.offsetWidth, e.body.offsetWidth), r.width() > t && (n = r.width())) : r.width() > a.width() && (n = r.width()), this.overlay.width(n).height(r.height())
        },
        onReady: function (t, e) {
            var i = this.overlay;
            n(".fancybox-overlay").stop(!0, !0), i || this.create(t), t.locked && this.fixed && e.fixed && (i || (this.margin = r.height() > a.height() ? n("html").css("margin-right").replace("px", "") : !1), e.locked = this.overlay.append(e.wrap), e.fixed = !1), !0 === t.showEarly && this.beforeShow.apply(this, arguments)
        },
        ...
        beforeShow: function (t) {
            var e = s.current,
                i = e.title,
                o = t.type;
            if (n.isFunction(i) && (i = i.call(e.element, e)), d(i) && "" !== n.trim(i)) {
                switch (e = n('<div class="fancybox-title fancybox-title-' + o + '-wrap">' + i + "</div>"), o) {
                    ...
                    case "over":
                        ...
                        break;
                    default:
                        o = s.skin, e.appendTo("body"), l && e.width(e.width()), e.wrapInner('<span class="child"></span>'), s.current.margin[2] += Math.abs(h(e.css("margin-bottom")))
                }
        ...
        var e, i = n(this),
            ...
            a = function (a) {
                var r, l, c = n(this).blur(),
                    u = e;
                !(a.ctrlKey || a.altKey || a.shiftKey || a.metaKey || c.is(".fancybox-wrap") || (r = t.groupAttr || "data-fancybox-group", l = c.attr(r), l || (r = "rel", l = c.get(0)[r]), l && "" !== l && "nofollow" !== l && (c = o.length ? n(o) : i, c = c.filter("[" + r + '="' + l + '"]'), u = c.index(this)), t.index = u, !1 === s.open(c, t) || !a.preventDefault()))
            };
        return t = t || {}, e = t.index || 0, o && !1 !== t.live ? r.undelegate(o, "click.fb-start").delegate(o + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", a) : i.unbind("click.fb-start").bind("click.fb-start", a), this.filter("[data-fancybox-start=1]").trigger("click"), this
    }, r.ready(function () {
        var e, a;
    ...
    easeInElastic: function (t, e, n, i, o) {
        ...
        return -(s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * o - a) * Math.PI / r)) + n
    },
    easeOutElastic: function (t, e, n, i, o) {
        ...
        return s * Math.pow(2, -10 * e) * Math.sin(2 * (e * o - a) * Math.PI / r) + i + n
    },
    easeInOutElastic: function (t, e, n, i, o) {
        ...
        if (r || (r = .3 * o * 1.5), s < Math.abs(i)) {
            s = i;
            var a = r / 4
        } else var a = r / (2 * Math.PI) * Math.asin(i / s);
        return 1 > e ? -.5 * s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * o - a) * Math.PI / r) + n : s * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * (e * o - a) * Math.PI / r) * .5 + i + n
    },
...
img2load.push("img/loading.gif"), img2load.push("img/b-a.png"), img2load.push("img/b-c.png"), img2load.push("img/b-cdehunt.png"), img2load.push("img/b-cpu.jpg"), img2load.push("img/b-e1.png"), img2load.push("img/b-eng.jpg"), img2load.push("img/b-fin.jpg"), img2load.push("img/b-gue.jpg"), img2load.push("img/b-its.jpg"), img2load.push("img/b-kb.jpg"), img2load.push("img/b-kin.png"), img2load.push("img/b-nte.png"), img2load.push("img/b-opc.png"), img2load.push("img/b-oth.jpg"), img2load.push("img/b-pos.jpg"), img2load.push("img/b-ppt.jpg"), img2load.push("img/b-proj.jpg"), img2load.push("img/b-qui.jpg"), img2load.push("img/b-s.jpg"), img2load.push("img/b-smrt.png"), img2load.push("img/b-spy.jpg"), img2load.push("img/b-te.png"), img2load.push("img/b-w.png"), img2load.push("img/b-who.png"), img2load.push("img/b-wro.png"), img2load.push("img/carousel0.jpg"), img2load.push("img/carousel1.jpg"), img2load.push("img/contact.png"), img2load.push("img/estate.png"), img2load.push("img/l-cdehunt.png"), img2load.push("img/l-cpu.png"), img2load.push("img/l-eng.jpg"), img2load.push("img/l-fin.jpg"), img2load.push("img/l-geek.png"), img2load.push("img/l-gue.jpg"), img2load.push("img/l-its.jpg"), img2load.push("img/l-key.png"), img2load.push("img/l-koc.png"), img2load.push("img/l-opc.png"), img2load.push("img/l-oth.png"), img2load.push("img/l-pd.png"), img2load.push("img/l-pe.jpg"), img2load.push("img/l-pos.jpg"), img2load.push("img/l-ppt.jpg"), img2load.push("img/l-proj.jpg"), img2load.push("img/l-qui.jpg"), img2load.push("img/l-qui.png"), img2load.push("img/l-smrt.png"), img2load.push("img/l-spy.png"), img2load.push("img/l-tnt.png"), img2load.push("img/l-who.png"), img2load.push("img/l-wro.png"), img2load.push("img/logo.png"), img2load.push("img/main code.png"), img2load.push("img/opc_logo.png"), img2load.push("img/s-bg.png"), img2load.push("img/s-c.png"), img2load.push("img/s-d.png"), img2load.push("img/s-dh.png"), img2load.push("img/s-gc.png"), img2load.push("img/s-i.png"), img2load.push("img/s-ncc.png"), img2load.push("img/s-pg.png"), img2load.push("img/s-sa.png"), img2load.push("img/s-sc.png"), img2load.push("img/s-sl.png"), img2load.push("img/s-sva.png"), img2load.push("img/s-v.png"), img2load.push("img/s-vi.png");
for (var totimg = img2load.length, imagesloaded = 0, anImageLoaded = function () {
        imagesloaded++, document.getElementById("loading").innerHTML = Math.floor(imagesloaded / totimg * 100) + " %"
    }, i = 0; totimg > i; i++) {
    var s = new Image;
    s.onload = function () {
        anImageLoaded()
...
var loop = 1,
    ss = slideshow();
$pages.eq(current).addClass("pt-page-current"), $(window).resize(function () {
    setnavbar()
}), setnavbar(), onReady(function () {
    show("navigation", !0), show("pt-main", !0), show("loading", !1)
}), $("#firstpage").scroll(function () {
    $("#firstpage").scrollTop() > 400 ? $("#navigation").css("background-color", "#008B45") : $("#navigation").css("background-color", "rgba(16, 22, 54, 0.2)")
}), onReady(function () {
    $(".project-wrapper").mixItUp(), $(".fancybox").fancybox({
        padding: 0,
        type: "image",
        openEffect: "elastic",
        openSpeed: 650,
